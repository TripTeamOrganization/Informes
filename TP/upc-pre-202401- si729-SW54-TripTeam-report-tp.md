...
|US05|Búsqueda por filtros|<p>**Como** usuario</p><p>**Quiero** buscar vuelos, alojamientos, restaurantes y actividades utilizando filtros</p><p>**Para** explorar opciones según mis intereses y preferencias</p>|<p>**Escenario 1:** Filtrar por precio</p><p></p><p>**Dado que** el usuario quiere buscar un vuelo, alojamiento, restaurante o actividad en un rango de precio</p><p>**Cuando** utilice el slider de precio en la sección</p><p>**Entonces** debería ver una variedad de opciones según el precio ingresado</p><p></p><p>**Escenario 2:** Filtro por horario</p><p></p><p>**Dado que** el usuario quiere seleccionar un restaurante, una actividad o un vuelo</p><p>**Cuando** realice la búsqueda por filtro de horario de apertura</p><p>**Entonces** debería ver las opciones según el horario ingresado</p><p></p><p>**Escenario 3:** Filtro por camas</p><p></p><p>**Dado que** el usuario quiere seleccionar un restaurante, una actividad o un vuelo</p><p>**Cuando** realice la búsqueda por filtro de horario de apertura</p><p>**Entonces** debería ver las opciones según el horario ingresado</p>|EP03|
