...
|US21|Sección “Acerca de nosotros”|<p>**Como** visitante del landing page</p><p>**Quiero** poder visualizar una sección que me informe sobre el startup</p><p>**Para** conocer al equipo de TripMate y su propósito</p>|<p>**Escenario 1:** Información sobre el startup</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** navegue hacia la sección "Acerca de nosotros"</p><p>**Entonces** debería ver información detallada sobre el startup TripMate y su propósito</p><p></p><p>**Escenario 2:** Conocer al equipo de TripMate</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** acceda a la sección "Acerca de nosotros"</p><p>**Entonces** debería encontrar detalles sobre el equipo de TripMate</p>|EP07|
...
|US23|Sección “Testimonios”|<p>**Como** visitante del landing page</p><p>**Quiero** poder ver testimonios y experiencias de otros usuarios</p><p>**Para** conocer la opinión del público sobre TripMate</p>|<p>**Escenario 1:** Ver testimonios de otros usuarios</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** acceda a la sección "Testimonios"</p><p>**Entonces** debería poder ver testimonios y experiencias de otros usuarios sobre TripMate</p><p></p><p>**Escenario 2:** Conocer la opinión del público</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** acceda a la sección "Testimonios"</p><p>**Entonces** debería poder formarse una opinión sobre TripMate a partir de los testimonios de otros usuarios</p>|EP07|
...
|TS08|Get Payment Method|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información sobre métodos de pago por usuario mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Obtener método de pago</p><p></p><p>**Dado que** el endpoint “/metodos-pago” está disponible</p><p>**Cuando** una get request es enviada con el identificador del método de pago</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se obtiene los datos del método de pago</p><p></p><p>**Escenario 2:** Obtener método de pago no disponible</p><p></p><p>**Dado** que el endpoint “/metodos-pago” está disponible</p><p>**Cuando** una get request es enviada con el identificador del método de pago</p><p>**Y** el identificador no exista</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No existe un método de pago con este identificador”</p>|
|TS09|Get Information by Places|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información de los destinos de viaje mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Obtener información</p><p></p><p>**Dado que** el endpoint “/destinos” está disponible</p><p>**Cuando** una get request es enviada con el identificador del destino</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se obtiene los datos del destino</p><p></p><p>**Escenario 2:** Obtener información de destino no disponible</p><p></p><p>**Dado** que el endpoint “/destinos” está disponible</p><p>**Cuando** una get request es enviada con el identificador del destino</p><p>**Y** el identificador no exista</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No existe un destino con este identificador”</p>|
|TS10|Post Review|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar reseñas de los usuarios mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p><p></p><p>**Escenario 1:** Añadir reseña nueva</p><p></p><p>**Dado que** el endpoint “/reseñas” está disponible</p><p>**Cuando** una post request es enviada con los valores de la reseña</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se incluye una reseña con un nuevo id y sus valores registrados</p><p></p><p>**Escenario 2:** Añadir reseña ya existente</p><p></p><p>**Dado que** el endpoint “/reseñas” está disponible</p><p>**Cuando** una post request es enviada con los datos de la reseña</p><p>**Y** una reseña ya esté registrado con esos datos</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “Una reseña con estos datos ya existe”</p>|
|TS11|Get Review|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información sobre las reseñas de distintos lugares, alojamientos o actividades</p><p>**Para** mostrarlas en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Obtener usuario</p><p></p><p>**Dado que** el endpoint “/reseñas” está disponible</p><p>**Cuando** una get request es enviada con el identificador de la reseña</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se obtiene los datos de la reseña</p><p></p><p>**Escenario 2:** Obtener usuario no disponible</p><p></p><p>**Dado** que el endpoint “/reseñas” está disponible</p><p>**Cuando** una get request es enviada con el identificador de la reseña</p><p>**Y** el identificador no exista</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No existe una reseña con este identificador”</p>|
