...
| Jeremy Quispe                        |![image](https://github.com/TripTeamOrganization/Informes/blob/9e3900c15d9c418e8f7a2a771d7dfe3bd3100dbc/imagenes/FotoJeremy.png)| Cursando el 5to ciclo de Ingeniería de Software en la UPC. Interés en crear soluciones tecnológicas con impacto positivo en la sociedad. Agradece a la universidad por brindar recursos para su desarrollo. |
| Leonel Alfaro Cumba                 |![image](https://github.com/TripTeamOrganization/Informes/blob/9e3900c15d9c418e8f7a2a771d7dfe3bd3100dbc/imagenes/FotoLeonel.png)|Estudiante de Ingeniería de Software con gran interés en la tecnología y la innovación. Motivado por ampliar conocimientos y desarrollarse constantemente. |
| Paolo Del Carmen Martinez Villanueva |![image](https://github.com/TripTeamOrganization/Informes/blob/9e3900c15d9c418e8f7a2a771d7dfe3bd3100dbc/imagenes/FotoPaolo.png)|Estudiante del 6to ciclo de Ingeniería de Software. Conocimientos intermedios en programación. Responsable, ordenado y trabajador. Comprometido a apoyar al equipo y adquirir nuevos conocimientos. |
