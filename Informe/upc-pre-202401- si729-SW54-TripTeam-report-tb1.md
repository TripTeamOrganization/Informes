...
|TS10|Get Budget|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información sobre el presupuesto de los usuarios mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Obtener presupuesto</p><p></p><p>**Dado que** el endpoint “/presupuestos” está disponible</p><p>**Cuando** una get request es enviada con el identificador del usuario</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se obtiene los datos del presupuesto del usuario</p><p></p><p>**Escenario 2:** Obtener presupuesto no disponible</p><p></p><p>**Dado** que el endpoint “/presupuestos” está disponible</p><p>**Cuando** una get request es enviada con el identificador del usuario</p><p>**Y** el identificador no exista</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No existe un presupuesto asociado con este identificador”</p>|
|TS11|Post Expenses|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar pagos** realizados por los usuarios en sus viajes mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p><p></p><p>**Escenario 1:** Añadir pago nuevo</p><p></p><p>**Dado que** el endpoint “/pagos” está disponible</p><p>**Cuando** una post request es enviada con los valores del pago</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se incluye un pago con un nuevo id y sus valores registrados</p><p></p><p>**Escenario 2:** Añadir pago ya existente</p><p></p><p>**Dado que** el endpoint “/pagos” está disponible</p><p>**Cuando** una post request es enviada con los datos del pago</p><p>**Y** un pago ya esté registrado con esos datos</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “Un pago con estos datos ya existe”</p>|
|TS12|Get Expenses|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información sobre los gastos por usuario mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Obtener pago</p><p></p><p>**Dado que** el endpoint “/pagos” está disponible</p><p>**Cuando** una get request es enviada con el identificador del pago</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se obtiene los datos del pago</p><p></p><p>**Escenario 2:** Obtener pago no disponible</p><p></p><p>**Dado** que el endpoint “/pagos” está disponible</p><p>**Cuando** una get request es enviada con el identificador del pago</p><p>**Y** el identificador no exista</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No existe un pago con este identificador”</p>|
|TS13|Post Review|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar reseñas de los usuarios mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p><p></p><p>**Escenario 1:** Añadir reseña nueva</p><p></p><p>**Dado que** el endpoint “/reseñas” está disponible</p><p>**Cuando** una post request es enviada con los valores de la reseña</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se incluye una reseña con un nuevo id y sus valores registrados</p><p></p><p>**Escenario 2:** Añadir reseña ya existente</p><p></p><p>**Dado que** el endpoint “/reseñas” está disponible</p><p>**Cuando** una post request es enviada con los datos de la reseña</p><p>**Y** una reseña ya esté registrado con esos datos</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “Una reseña con estos datos ya existe”</p>|
...
|25|US23|Dar feedback|<p>**Como** usuario</p><p>**Quiero** poder proporcionar feedback sobre la aplicación</p><p>**Para** compartir sugerencias o comentarios que ayuden a mejorar la experiencia del usuario</p>|<p></p><p>2</p>|
...
|32|TS01|Post User|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar a un nuevo usuario mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p>|<p></p><p>3</p>|
...
|34|TS03|Post Reservation|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar una nueva reserva asociada a un usuario mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p>|<p></p><p>5</p>|
|35|TS04|Get Reservation|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de las reservas por usuario mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>3</p>|
|36|<p>TS05</p><p></p>|Post Itinerary|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar un nuevo itinerario asociado a un usuario mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p>|<p></p><p>5</p>|
|37|TS06|Get Itinerary|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información sobre itinerarios de viaje por usuario **mediante una API**</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>3</p>|
|38|TS07|Post Payment** Method|<p>**Como** desarrollador que trabaja en la aplicación de Tripmate</p><p>**Quiero** registrar un método de pago asociado a un usuario mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p>|<p></p><p>3</p>|
|39|TS08|Get Payment Method|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información sobre métodos de pago por usuario mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>3</p>|
|40|TS09|Get Information by Places|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información de los destinos de viaje mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>3</p>|
|41|TS10|Get Budget|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información sobre el presupuesto de los usuarios mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>3</p>|
|42|TS11|Post Expenses|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar pagos** realizados por los usuarios en sus viajes mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p>|<p></p><p>5</p>|
|43|TS12|Get Expenses|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información sobre los gastos por usuario mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>3</p>|
|44|TS13|Post Review|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar reseñas de los usuarios mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p>|<p></p><p>5</p>|
|45|TS14|Get Review|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información sobre las reseñas de distintos lugares, alojamientos o actividades</p><p>**Para** mostrarlas en la aplicación cuando se solicite</p>|<p></p><p>3</p>|
