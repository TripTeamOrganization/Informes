...
|US23|Sección “Testimonios”|<p>**Como** visitante del landing page</p><p>**Quiero** poder ver testimonios y experiencias de otros usuarios</p><p>**Para** conocer la opinión del público sobre TripMate</p>|<p>**Escenario 1:** Ver testimonios de otros usuarios</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** acceda a la sección "Testimonios"</p><p>**Entonces** debería poder ver testimonios y experiencias de otros usuarios sobre TripMate</p><p></p><p>**Escenario 2:** Conocer la opinión del público</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** acceda a la sección "Testimonios"</p><p>**Entonces** debería poder formarse una opinión sobre TripMate a partir de los testimonios de otros usuarios
</p>|<p>EP07</p><p></p>|
|US24|Acceder desde cualquier dispositivo a la landing page|<p>**Como** visitante del landing page</p><p>**Quiero** poder acceder al sitio web desde diferentes dispositivos</p><p>**Para** poder ingresar al sitio web desde cualquier dispositivo</p>|<p>**Escenario 1:** Accesibilidad desde diferentes dispositivos</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** cceda al sitio web desde un dispositivo diferente (móvil, tablet, PC)</p><p>**Entonces** debería poder visualizar la página correctamente en cualquier dispositivo</p><p></p><p>**Escenario 2:** Acceso fácil desde cualquier lugar</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** intente acceder al sitio web desde mi dispositivo habitual</p><p>**Entonces** debería poder ingresar a la página de TripMate desde cualquier lugar y dispositivo</p><p></p>|EP07|
