...
|---------------------|----------------------|--------------|
|Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería.| Adrián Enrique Jesús Palma Obispo<br><b>TB1</b><br>Para esta entrega comuniqué mis ideas y propuse nuevas soluciones en las llamadas grupales, además de participar activamente en estas.<br><br><b>TP</b><br>Para esta entrega informé al grupo sobre mis avances en la aplicación web y estuve presente en las llamadas grupales.<br><br><b>TB2</b><br>Para esta tercera entrega estuve presente en algunas de las llamadas grupales para comunicar ideas y conocimientos sobre backend para el desarrollo de la aplicación web.<br><br><b>TF</b><br>Para esta última entrega estuve presente en algunas de las llamadas grupales para comunicar ideas y conocimientos sobre backend para el desarrollo de la aplicación web.<br><br>Bárbara Antonella Espinoza Delgado<br><b>TB1</b><br>Me mantuve activa en la participación y comunicación oral en las llamadas grupales, dando ideas de mejora y ayuda tanto para el informe como para la Landing Page.<br><br><b>TP</b><br>Para esta entrega estuve presente en las llamadas grupales para comunicar mis dudas y avances sobre el desarrollo de la aplicación web.<br><br><b>TB2</b><br>Para esta tercera entrega estuve presente en todas las llamadas grupales para comunicar los avances y correcciones en el codigo y pedir ayuda con otras partes del proyecto.<br><br><b>TF</b><br>Para esta última entrega estuve presente en todas las llamadas grupales para comunicar los avances y correcciones en el codigo tanto en las ultimas partes faltantes del frontend como del backend.<br><br>Jeremy Joel Quispe Andia<br><b>TB1</b><br>Participe en las llamadas grupales de cada semana pidiendo opiniones y nuevas ideas de implementación para la Landing Page. Además, realicé entrevistas a los usuarios para conocer sus opiniones y recomendaciones acerca del proyecto.<br><br><b>TP</b><br>Para esta entrega realicé llamadas grupales continuamente para que los integrantes se repartieran tareas semanales y se ayuden entre ellos.<br><br><b>TB2</b><br>Para esta entrega realicé llamadas grupales para comentar sobre la planificación y desarrollo del backend la aplicación web.<br><br><b>TF</b><br>Para esta cuarta entrega realicé llamadas grupales para comentar sobre la planificación y repartición de tareas.<br><br>Leonel Alfaro Cumba<br><b>TB1</b><br>Estuve presente en las llamadas grupales y comunicaba mis dudas e ideas al grupo sobre los puntos que me tocaba realizar, como las entrevistas, donde me encargue de resumir las respuestas de los usuarios entrevistados.<br><br><b>TP</b><br>En esta segunda entrega estuve comunicando mis dudas acerca del desarrollo de la aplicación durante las llamadas grupales en Discord.<br><br><b>TB2</b><br>Para esta entrega estuve presente en algunas de las llamadas grupales para comentar sobre mis correcciones y avances en el backend de la aplicación.<br><br><b>TF</b><br>Para esta última entrega estuve presente en todas las llamadas grupales para comentar sobre mis avances y mejoras en el backend de la aplicación.<br><br>Paolo Del Carmen Martinez Villanueva<br><b>TB1</b><br>Comuniqué mi idea de proyecto mediante la primera llamada grupal, la cual quedó como finalista y me encargue de especificar cada punto de la idea a todos los integrantes.<br><br><b>TP</b><br>En esta entrega colaboré activamente en las llamadas grupales y comuniqué sobre mis avances y correcciones.<br><br><b>TB2</b><br>Para esta entrega estuve comunicando sobre mis avances en el backend del proyecto y estando pendiente de las dudas de mis demas compañeros.<br><br><b>TF</b><br>Para esta entrega estuve comunicando sobre mis avances en el backend del proyecto y sobre mis conocimientos adquiridos para aplicarlos en el trabajo.<br>|<b>TB1</b><br> Como conclusión para esta primera entrega del proyecto, hemos confirmado que la comunicación oral grupal desde el inicio del proyecto es fundamental para un buen inicio de trabajo. No solo nos ha permitido conocernos entre nosotros, sino que también ha servido como plataforma para expresar nuestras ideas, dudas y consultas de manera efectiva, lo cual ha contribuido significativamente a la organización y la claridad en el desarrollo del proyecto. Al participar activamente en las llamadas grupales, hemos establecido una base sólida de comprensión mutua y confianza, lo que facilita la asignación de tareas y la colaboración en equipo. Además, estas interacciones nos han permitido identificar áreas clave que requieren atención y enfoque, asegurando que abordemos los desafíos de manera proactiva y eficiente. En resumen, la comunicación oral grupal no solo es esencial para compartir información, sino que también es fundamental para construir relaciones sólidas y establecer una estructura organizativa efectiva que guiará nuestro progreso en las siguientes etapas del proyecto.<br><br><b>TP</b><br> Como conclusión para esta segunda entrega del proyecto, hemos promovido la comunicación oral grupal ya que al ser un trabajo de mayor complejidad, la comunicación ha sido necesaria para apoyarnos entre nosotros en nuestras tareas semanales. Al participar activamente en las llamadas grupales, hemos reconocido los conocimientos que tiene cada integrante. Además, estas interacciones nos han permitido resolver las dudas de cada integrante y compartir nuestros aprendizajes.<br><br><b>TB2</b><br> Como conclusión para esta tercera entrega del proyecto, hemos reforzado la comunicación oral grupal ya que por el tiempo que se viene realizando el trabajo, el grupo entero comunica mas abiertamente sus ideas, avances, dudas y errores. Esto evidencia un correcto y positivo trabajo en equipo.<br><br><b>TF</b><br> Como conclusión para esta cuarta y última entrega del trabajo, hemos concluido con las partes faltantes y nos hemos mantenido comunicados mediante llamadas para verificar los avances y correcciones de todos los integrantes del grupo además de dar ideas sobre como resolver los errores y fallos en el trabajo.|
|Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerarquicos, en el marco del desarrollo de un proyecto en ingeniería.|Adrián Enrique Jesús Palma Obispo<br><b>TB1</b><br>Realice las partes escritas del informe que me correspondían, en especial los Sprints y las conclusiones, además de ayudar en otras partes a mis compañeros.<br><br><b>TP</b><br>En esta segunda entrega actualicé y modifiqué partes escritas del informe, además de realizar partes fundamentales en la elaboración de la aplicación web.<br><br><b>TB2</b><br>En esta tercera entrega realicé partes escritas del informe en el capítulo 5 como la tabla de commits. Además, realicé la parte que me correspondía del código de la aplicación.<br><br><b>TF</b><br>En esta cuarta entrega realicé partes escritas del informe en el capítulo 5.4 como la tabla de commits. Además, realicé la parte que me tocó realizar del código de la aplicación.<br><br>Bárbara Antonella Espinoza Delgado<br><b>TB1</b><br>Realice de manera puntual las partes escritas que me correspondían en el proyecto, además de incluir fuentes bibliográficas que respalden el proyecto e ir comunicando a mis compañeros los avances que tenía y realice las correcciones considerando sus ideas de mejora y nuevas propuestas.<br><br><b>TP</b><br>Realice las tres primeras partes escritas del informe, ademas de colaborar con la realización de la aplicación web en diversas secciones.<br><br><b>TB2</b><br>En esta tercera entrega colaboré con las entrevistas y el diseño y resumen de estas. También aporté en el avance y corrección del código del frontend y backend.<br><br><b>TF</b><br>En esta última entrega colaboré con el Sprint 4. También aporté en el avance y corrección del código del frontend y backend.<br><br><br>Jeremy Joel Quispe Andia<br><b>TB1</b><br>Me encargue de redactar el capítulo 2 del informe y colaborar en otros puntos textuales del informe. También fui quien envió la idea finalista al profesor, recibir su retroalimentación y comunicar al resto del grupo.<br><br><b>TP</b><br>Me encargué de realizar correciones de la entrega anterior del informe y colaboré con la organización y realización del código del proyecto.<br><br><b>TB2</b><br>En esta tercera entrega realicé mi parte asignada del informe y colaboré con el avance del código del backend de la aplicación web.<br><br><b>TF</b><br>En esta última entrega realicé una parte del informe y ayudé con el avance del código del backend de la aplicación web.<br><br>Leonel Alfaro Cumba<br><b>TB1</b><br>Realicé una importante sección de la Landing Page en la que tenía que describir resumidamente a la Startup y al grupo en general y me mantuve comunicado mediante el grupo de Whatsapp para hacer mis consultas.<br><br><b>TP</b><br>Me encargué de la redacción de partes fundamentales en el informe de esta segunda entrega y entregué mis tareas relacionadas a la aplicación web puntualmente<br><br><b>TB2</b><br>En esta tercera entrega me encargué de una gran parte escrita del capítulo 5.3 del informe, además de colaborar con las entrevistas y el código del proyecto.<br><br><b>TF</b><br>En esta última entrega cumplí con mi parte asignada del informe, además de corregir partes de la entrega anterior.<br><br>Paolo Del Carmen Martinez Villanueva<br><b>TB1</b><br>Me encargue de la creación y redacción de los puntos del capítulo 3, además de ayudar en el capítulo 5 y realizar una sección con contenido textual en la Landing Page.<br><br><b>TP</b><br>Realicé correciónes y modificaciones en el informe escrito de esta entrega y realice puntual y correctamente mis tareas asignadas de la aplicación web.<br><br><b>TB2</b><br>En esta tercera entrega aporté con las heurísticas en el informe escrito del proyecto. Y por el lado del código, tambien aporté con mis avances que se me asignaron.<br><br><b>TF</b><br>En esta cuarta entrega aporté con excecution evidence en el informe escrito del proyecto. Y en el código, tambien aporté con todo lo que se me asignó en la repartición de tareas.<br>|<b>TB1</b><br>La comunicación escrita desempeña un papel insustituible en nuestro equipo, actuando como un medio vital para mantenernos informados de manera constante sobre los progresos y las inquietudes que surgen en el transcurso del proyecto. A través de la documentación escrita, no solo consolidamos y compartimos nuestras investigaciones y aprendizajes, sino que también creamos un registro detallado y accesible de nuestro trabajo. Esta transcripción minuciosa no solo refleja nuestro compromiso con la transparencia y la organización interna, sino que también se erige como un recurso invaluable para cualquier individuo interesado en comprender los detalles y las razones detrás de nuestras decisiones y acciones. En última instancia, esta práctica no solo fortalece la cohesión y la eficacia de nuestro equipo, sino que también garantiza que nuestro proyecto sea accesible y comprensible para una audiencia más amplia, lo que amplifica su impacto y su alcance potencial.<br><br><b>TP</b><br>En esta segunda entrega de nuestra aplicación web, la comunicación escrita sigue siendo esencial para nuestro equipo al mantenernos informados de manera constante sobre los avances y preocupaciones del proyecto. A través de la documentación escrita, consolidamos nuestros descubrimientos y aprendizajes, creando un registro detallado y accesible de nuestro trabajo. Esta práctica refleja nuestro compromiso con la transparencia y la organización interna, siendo un recurso valioso para aquellos interesados en comprender nuestras decisiones y acciones. Además, fortalece la cohesión del equipo y asegura que nuestro proyecto sea accesible y comprensible para una audiencia más amplia, amplificando así su impacto y alcance potencial.<br><br><b>TB2</b><br>En esta tercera entrega de nuestra aplicación web, la comunicación escrita se ha incrementado entre el grupo, informando a traves de mensajes nuestros avances y dudas constantemente en horas que no es posible realizar llamadas grupales. Por el lado del informe escrito, al intercambiar las partes asignadas en las entregas anteriores, corroboramos que todos podíamos realizar cualquier parte del informe y audar a quien se le dificultase la realización de su tarea asignada.<br><br><b>TF</b><br>En esta última entrega de nuestrproyecto, la comunicación escrita ha estado más presente el grupo, estando siempre pendientes a dudas de los integrantes del grupo. Por el lado del informe escrito, asignamos a cada integrante las partes con las que más familiarizados estaban y así poner mayor concentración en el desarrollo del código de la aplicación.|
...
|EP02|Gestión de cuentas|<p>**Como** usuario</p><p>**Quiero** poder administrar y personalizar mi cuenta</p><p>**Para** poder realizar** cambios en mi cuenta</p>|<p>US03 – Recuperación de contraseña</p><p>US04 – Cambiar dirección de correo electrónico</p><p>US25 – Suscripción a membresía premium</p><p>US26 – Eliminar cuenta</p>|
|EP03|Planificación de viajes|<p>**Como** usuario</p><p>**Quiero** poder ver vuelos, alojamientos, actividades y restaurantes</p><p>**Para** poder planificar mi viaje</p>|<p>US05 – Búsqueda por filtros</p><p>US06 – Ver alojamientos</p><p>US07 – Ver vuelos</p><p>US08 – Ver actividades</p><p>US09 – Ver restaurantes</p>|
|EP04|Reservas y planificación de itinerarios|<p>**Como** usuario</p><p>**Quiero** poder realizar reservas y planificar itinerarios</p><p>**Para** preparar mi viaje</p>|<p>US10 – Reservar alojamiento</p><p>US11 – Reservar vuelos</p><p>US12 – Reservar actividades</p><p>US13 – Reservar restaurantes</p><p>US14 – Planificar itinerario</p><p>US15 - Realizar pago</p>|
|EP05|Contacto|<p>**Como** visitante del landing page</p><p>**Quiero** contar con una sección que me permita contactar con los desarrolladores de la aplicación</p><p>**Para** resolver algún problema o dar mi opinión sobre la aplicación </p>|<p>US17 – Contactar al soporte</p><p>US18 – Dar feedback</p>|
|EP06|Optimización de la experiencia del usuario|<p>**Como** visitante del landing page</p><p>**Quiero** visualizar una presentación atractiva</p><p>**Para** conocer los servicios y características que ofrece TripMate</p>|<p>US19 – Visualizar una landing page atractiva</p><p>US20 – Visualizar features de la aplicación</p><p>US21 – Sección "Acerca de nosotros"</p><p>US22 – Sección "Convenios"</p><p>US23 – Sección "Testimonios"</p><p>US24 – Acceder desde cualquier dispositivo a la landing page</p>|
|EP07|Descuentos|<p>**Como** usuario</p><p>**Quiero** poder acceder a descuentos en la aplicación</p><p>**Para** ahorrar dinero en mis viajes</p>|<p>US16 – Aplicación de códigos promocionales</p>|
...
|US03|Recuperación de contraseña|<p>**Como** usuario registrado</p><p>**Quiero** tener la opción de recuperación de contraseña</p><p>**Para** poder acceder a mi cuenta sin problemas</p>|<p>**Escenario 1:** Solicitud de recuperación de contraseña exitosa</p><p></p><p>**Dado que** el usuario ha olvidado su contraseña</p><p>**Cuando** acceda a la opción de recuperar contraseña</p><p>**Y** coloca el correo asociado a su cuenta</p><p>**Entonces** recibirá un correo electrónico con instrucciones para recuperar su contraseña</p><p></p><p>**Escenario 2:** Solicitud de recuperación de contraseña fallida</p><p></p><p>**Dado que** el usuario ha olvidado su contraseña</p><p>**Cuando** accede a la opción de recuperar contraseña</p><p>**Y** coloca un correo no asociado a su cuenta</p><p>**Entonces** mostrará un mensaje de error</p><p>**Y** deberá ingresar su correo nuevamente</p><p></p>|EP02|
|US04|Cambiar dirección de correo electrónico|<p>**Como** usuario</p><p>**Quiero** poder cambiar la dirección de correo electrónico asociada a mi cuenta</p><p>**Para** mantener mi información de contacto actualizada</p>|<p>**Escenario 1:** Acceder a la configuración de la cuenta</p><p></p><p>Dado que el usuario está registrado y ha iniciado sesión en la aplicación</p><p>Cuando acceda a la configuración de su cuenta desde el menú de perfil</p><p>Entonces podrá encontrar una opción para cambiar su dirección de correo electrónico</p><p></p><p>**Escenario 2:** Verificación de la nueva dirección de correo electrónico</p><p></p><p>**Dado que** el usuario ha ingresado una nueva dirección de correo electrónico en la configuración de su cuenta</p><p>**Cuando** guarde los cambios y la aplicación solicite verificar la nueva dirección</p><p>**Entonces** recibirá un correo electrónico de verificación en la nueva dirección y seguirá un proceso para confirmar el cambio</p><p></p>|EP02|
|US05|Búsqueda por filtros|<p>**Como** usuario</p><p>**Quiero** buscar vuelos, alojamientos, restaurantes y actividades utilizando filtros</p><p>**Para** explorar opciones según mis intereses y preferencias</p>|<p>**Escenario 1:** Filtrar por precio</p><p></p><p>**Dado que** el usuario quiere buscar un vuelo, alojamiento, restaurante o actividad en un rango de precio</p><p>**Cuando** utilice el slider de precio en la sección</p><p>**Entonces** debería ver una variedad de opciones según el precio ingresado</p><p></p><p>**Escenario 2:** Filtro por nombre</p><p></p><p>**Dado que** el usuario quiere buscar un restaurante, una actividad o un vuelo</p><p>**Cuando** realice la búsqueda por filtro por nombre</p><p>**Entonces** debería ver las tarjetas según el nombre de la tarjeta</p><p></p><p>**Escenario 3:** Filtro por opciones</p><p></p><p>**Dado que** el usuario quiere filtrar alojamientos, un restaurante, una actividad o un vuelo</p><p>**Cuando** realice la búsqueda por filtro segun en la sección en que se encuentra </p><p>**Entonces** debería ver las opciones  dependiendo la sección</p>|EP03|
|US06|Ver alojamientos|<p>**Como** usuario</p><p>**Quiero** ver todos los alojamientos disponibles en la aplicación</p><p>**Para** poder planificar mi viaje y mi itinerario</p>|<p>**Escenario 1:** Ver alojamientos</p><p></p><p>**Dado que** el usuario quiere ver alojamientos disponibles</p><p>**Cuando** ingrese al apartado de alojamientos</p><p>**Entonces** podrá ver el nombre, la dirección, una breve descripción y el precio de todos los alojamientos disponibles</p><p></p><p>**Escenario 2:** Ver alojamientos por precio</p><p></p><p>**Dado que** el usuario quiere ver alojamientos disponibles en un rango de precio</p><p>**Cuando** acomode el rango de precio en el slider de precio</p><p>**Entonces** podrá ver el nombre, la dirección, una breve descripción y el precio de todos los alojamientos que se encuentren en el rango de precio ingresado</p>|EP03|
|US07|Ver vuelos|<p>**Como** usuario</p><p>**Quiero** ver todos vuelos disponibles en la aplicación</p><p>**Para** poder planificar mi viaje y mi itinerario</p>|<p>**Escenario 1:** Ver vuelos</p><p></p><p>**Dado que** el usuario quiere ver todos los vuelos disponibles</p><p>**Cuando** ingrese al apartado de vuelos</p><p>**Entonces** podrá ver todos los vuelos disponibles incluyendo su precio y el destino</p><p></p><p>**Escenario 2:** Ver vuelos por precio</p><p></p><p>**Dado que** el usuario quiere ver vuelos disponibles en un rango de precio</p><p>**Cuando** acomode el rango de precio en el slider de precio</p><p>**Entonces** podrá ver los vuelos disponibles en el rango de precio ingresado</p><p></p><p>**Escenario 3:** Ver vuelos por horario</p><p></p><p>**Dado que** el usuario quiere ver vuelos disponibles en un horario específico</p><p>**Cuando** ingrese el horario que desee</p><p>**Entonces** podrá ver los vuelos disponibles en ese horario|EP03|
|US08|Ver actividades|<p>**Como** usuario</p><p>**Quiero** ver todas las actividades disponibles en la aplicación</p><p>**Para** poder planificar mi viaje y mi itinerario</p>|**Escenario 1:** Ver actividades</p><p></p><p>**Dado que** el usuario quiere ver todas las actividades para planificar su itinerario</p><p>**Cuando** ingrese al apartado de actividades</p><p>**Entonces** podrá ver todas las actividades disponibles con su dirección, una breve descripción y su precio por persona</p><p></p><p>**Escenario 2:** Ver actividades por precio</p><p></p><p>**Dado que** el usuario quiere ver actividades disponibles en un rango de precio</p><p>**Cuando** acomode el rango de precio en el slider de precio</p><p>**Entonces** podrá ver el nombre, la dirección, una breve descripción y el precio de todas las actividades que se encuentren en el rango de precio ingresado</p><p></p><p>**Escenario 3:** Ver actividades por horario de apertura</p><p></p><p>**Dado que** el usuario quiere ver actividades disponibles en un horario específico</p><p>**Cuando** ingrese el horario que desee</p><p>**Entonces** podrá ver el nombre, la dirección, una breve descripción y el precio de todas las actividades que están disponibles en ese horario|EP03|
|US09|Ver restaurantes|<p>**Como** usuario</p><p>**Quiero** ver todos los restaurantes disponibles en la aplicación</p><p>**Para** poder planificar mi viaje y mi itinerario</p>|**Escenario 1:** Ver restaurantes</p><p></p><p>**Dado que** el usuario quiere ver todos los restaurantes</p><p>**Cuando** ingrese al apartado de restaurantes</p><p>**Entonces** podrá ver todos los restaurantes disponibles incluyendo su precio y su ubicación</p><p></p><p>**Escenario 2:** Ver restaurantes por precio</p><p></p><p>**Dado que** el usuario quiere ver restaurantes disponibles en un rango de precio</p><p>**Cuando** acomode el rango de precio en el slider de precio</p><p>**Entonces** podrá ver el nombre, la dirección, una breve descripción y el precio de todos los restaurantes que se encuentren en el rango de precio ingresado</p><p></p><p>**Escenario 3:** Ver restaurantes por horario de apertura</p><p></p><p>**Dado que** el usuario quiere ver restaurantes disponibles en un horario específico</p><p>**Cuando** ingrese el horario que desee</p><p>**Entonces** podrá ver el nombre, la dirección, una breve descripción y el precio de todos los restaurantes que están disponibles en ese horario|EP03|
|US10|Reservar alojamiento|<p>**Como** usuario </p><p>**Quiero** poder reservar alojamiento en la aplicación</p><p>**Para** asegurar mi hospedaje durante el viaje</p>|<p>**Escenario 1:** Selección de fecha y tipo de alojamiento</p><p></p><p>**Dado que** el usuario quiere reservar alojamiento para su viaje</p><p>**Cuando** seleccione las fechas de estadía y el tipo de alojamiento deseado</p><p>**Entonces** se mostrará una lista de opciones de alojamiento disponibles</p><p></p><p>**Escenario 2:** Alojamiento no disponible</p><p></p><p>**Dado que** el usuario ha elegido un alojamiento</p><p>**Cuando** ingrese al apartado “Reservar”</p><p>**Y** el alojamiento no esté disponible</p><p>**Entonces** se mostrará un mensaje de error “El alojamiento no está disponible” </p><p>**Escenario 3:** Eliminación de reserva alojamiento</p><p></p><p>**Dado que** el usuario ha realizado una reserva de alojamiento previamente.</p><p>**Cuando** acceda  la sección de carritos de compras </p><p>**Y** seleccione la reserva que desea cancelar</p><p>**Entonces** la reserva de elimanara de la lista de reserva |EP04|
|US11|Reservar vuelos|<p>**Como** usuario</p><p>**Quiero** poder reservar vuelos en la aplicación</p><p>**Para** poder planificar mi viaje de manera eficiente</p>|<p>**Escenario 1:** Búsqueda de vuelo</p><p></p><p>**Dado que** el usuario desea viajar</p><p>**Cuando** acceda a la sección de vuelos en la aplicación</p><p>**Entonces** podrá ver opciones de vuelos disponibles a su destino</p><p></p><p>**Escenario 2:** Reserva de vuelo</p><p></p><p>**Dado que** el usuario desea reservar un vuelo</p><p>**Cuando** encuentre el vuelo adecuado y seleccione el que más se le acomode</p><p>**Entonces** podrá reservar el vuelo para su destino</p><p>**Escenario 3:** Eliminación de reserva de vuelo</p><p></p><p>**Dado que** el usuario ha realizado una reserva de vuelo previamente</p><p>**Cuando** acceda  la sección de carritos de compras></p><p>**Y** seleccione el botón "Eliminar" en la reserva que desea cancelar</p><p>**Entonces** la reserva de vuelo se eliminará de la lista de reservas</p>|EP04|
|US12|Reservar actividades|<p>**Como** usuario</p><p>**Quiero** poder reservar actividades en la aplicación</p><p>**Para** poder planificar mi viaje de manera eficiente</p>|<p>**Escenario 1:** Búsqueda de actividades</p><p></p><p>**Dado que** el usuario desea reservar actividades</p><p>**Cuando** acceda a la sección de actividades en la aplicación</p><p>**Entonces** podrá ver opciones de actividades disponibles para reservar</p><p></p><p>**Escenario 2:** Reserva de actividad</p><p></p><p>**Dado que** el usuario desea reservar una actividad</p><p>**Cuando** encuentre la actividad deseada en base a sus preferencias</p><p>**Entonces** podrá reservar la actividad para su viaje</p><p>**Escenario 3:** Eliminación de reserva de actividad</p><p></p><p>**Dado que** el usuario ha realizado una reserva de actividad previamente</p><p>**Cuando** acceda a la sección de carritos de compras</p><p>**Y** seleccione el botón "Eliminar" en la reserva que desea cancelar</p>**Entonces** la reserva de actividad se eliminará de la lista de reservas</p>|EP04|
|US13|Reservar restaurantes|<p>**Como** usuario</p><p>**Quiero** poder reservar restaurantes en la aplicación</p><p>**Para** poder planificar mi viaje de manera eficiente</p>|<p>**Escenario 1:** Búsqueda de restaurante</p><p></p><p>**Dado que** el usuario desea reservar un restaurante</p><p>**Cuando** acceda a la sección de restaurantes en la aplicación</p><p>**Entonces** podrá ver opciones de restaurantes disponibles</p><p></p><p>**Escenario 2:** Reserva de restaurantes</p><p></p><p>**Dado que** el usuario desea reservar un restaurante</p><p>**Cuando** encuentre el restaurante adecuado según sus preferencias</p><p>**Entonces** podrá reservar el restaurante para su viaje</p><p>**Escenario 3:** Eliminación de reserva de restaurante</p><p></p><p>**Dado que** Dado que el usuario ha realizado una reserva de restaurante previamente</p><p>**Cuando** acceda a la sección de carritos de compras</p><p>**Y** seleccione el botón "Eliminar" en la reserva de restaurante que desea cancelar</p>**Entonces** la reserva de restaurante se eliminará de la lista de reservas </p> |EP04|
|US14|Planificar itinerario|<p>**Como** usuario</p><p>**Quiero** poder planificar mi itinerario en la aplicación</p><p>**Para** organizar mis actividades durante el viaje</p>|<p>**Escenario 1:** Agregar actividades</p><p></p><p>**Dado que** el usuario está planificando su viaje</p><p>**Cuando** explore las opciones de actividades </p><p>**Y** seleccione las que desea realizar</p><p>**Entonces** debería poder agregarlas a su itinerario con fecha y horario</p><p></p><p>**Escenario 2:** Visualizar itinerario</p><p></p><p>**Dado que** el usuario ha agregado actividades a su itinerario</p><p>**Cuando** acceda a la planificación de su viaje</p><p>**Entonces** podrá ver todas sus actividades organizadas por día y hora</p>|EP04|
|US15|Realizar pago|<p>**Como** usuario</p><p>**Quiero** poder realizar los pagos dentro de la aplicación</p><p>**Para** poder terminar de planificar el viaje</p>|<p>**Escenario 1:** Pago exitoso</p><p>**Dado que** el usuario ha organizado su viaje</p><p>**Cuando** quiera realizar el pago</p><p>**Entonces** la aplicación lo redireccionará a la sección de pago</p><p>**Y** podrá pagar el total de su viaje</p><p></p><p>**Escenario 2:** Pago fallido</p><p></p><p>**Dado que** el usuario ha organizado su viaje</p><p>**Y** desea realizar el pago</p><p>**Cuando** ingrese credenciales incorrectas en la sección de pago</p><p>**Entonces** la aplicación mostrará un mensaje de error</p><p>**Y** le permitirá volver a ingresar sus datos</p>|EP04|
|US16|Aplicación de códigos promocionales|<p>**Como** usuario</p><p>**Quiero** tener la opción de ingresar códigos promocionales durante el proceso de pago</p><p>**Para** obtener descuentos adicionales en los servicios ofrecidos</p><p></p>|<p>**Escenario 1:** Ingresar código promocional</p><p></p><p>**Dado que** el usuario tiene un código promocional válido</p><p>**Cuando** esté en la página de pago durante el proceso de reserva</p><p>**Entonces** debería poder ingresar el código promocional en un campo designado y ver el descuento reflejado en el precio total antes de confirmar la reserva.</p><p></p><p>**Escenario 2:** Código promocional utilizado</p><p></p><p>**Dado que** el usuario tiene un código promocional</p><p>**Cuando** ingrese el código</p><p>Y este no sea válido o haya sido utilizado</p><p>**Entonces** se mostrará un mensaje de error “Este código no es válido o ya ha sido utilizado”</p>|EP07|
|US17|Contactar al soporte|<p>**Como** usuario</p><p>**Quiero** poder contactar al equipo de soporte de la aplicación</p><p>**Para** obtener ayuda con problemas técnicos</p>|<p>**Escenario 1:** Envío de consulta</p><p></p><p>**Dado que** el usuario tiene una pregunta sobre el funcionamiento de la aplicación o desea realizar un reclamo</p><p>**Cuando** acceda a la sección de soporte</p><p>**Y** complete el formulario de contacto</p><p>**Entonces** podrá enviar su consulta al soporte</p><p></p><p>**Escenario 2:** Respuesta del soporte</p><p></p><p>**Dado que** el usuario ha enviado una consulta al soporte</p><p>**Cuando** reciba una respuesta</p><p>**Entonces** podrá recibir asistencia a su problema</p>|EP05|
|US18|Dar feedback|<p>**Como** usuario</p><p>**Quiero** poder proporcionar feedback sobre la aplicación</p><p>**Para** compartir sugerencias o comentarios que ayuden a mejorar la experiencia del usuario</p>|<p>**Escenario 1:** Compartir sugerencias</p><p></p><p>**Dado que** el usuario tiene una idea para mejorar la aplicación</p><p>**Cuando** acceda a la sección de contacto</p><p>**Entonces** podrá enviar un correo al equipo de desarrollo para poder mejorar la aplicación</p>|EP05|
|US19|Visualizar una landing page atractiva|<p>**Como** visitante del landing page</p><p>**Quiero** visualizar una landing page clara y atractiva</p><p>**Para** entender el propósito de la aplicación</p>|<p>**Escenario 01:** Landing page clara y atractiva</p><p></p><p>**Dado que** el visitante ve la landing page con imágenes, videos e información relevante</p><p>**Cuando** complete el proceso de registro y login</p><p>**Entonces** será redirigido a la aplicación web</p><p></p><p>**Escenario 2:** Acceso al landing page, pero no es responsive con cualquier dispositivo</p><p></p><p>**Dado que** el usuario está ingresando al landing page desde otro dispositivo</p><p>**Cuando** revise la información y lo note desordenado y desagradable para la vista</p><p>**Entonces** cierra nuestra landing page y se dedica a seguir navegando por internet</p>|EP06|
|US20|Visualizar features de la aplicación|<p>**Como** visitante del landing page</p><p>**Quiero** poder visualizar todos las funcionalidades y servicios que brinda TripMate</p><p>**Para** entender el uso de la aplicación</p>|<p>**Escenario 1:** Ver todas las funcionalidades y servicios</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** accede al sitio web de TripMate</p><p>**Entonces** Debería ver todas las funcionalidades y servicios que ofrece TripMate</p><p></p><p>**Escenario 2:** Entender el uso de la aplicación</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** explore las secciones de la página</p><p>**Entonces** debería comprender cómo utilizar la aplicación TripMate</p>|EP06|
|US21|Sección “Acerca de nosotros”|<p>**Como** visitante del landing page</p><p>**Quiero** poder visualizar una sección que me informe sobre el startup</p><p>**Para** conocer al equipo de TripMate y su propósito</p>|<p>**Escenario 1:** Información sobre el startup</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** navegue hacia la sección "Acerca de nosotros"</p><p>**Entonces** debería ver información detallada sobre el startup TripMate y su propósito</p><p></p><p>**Escenario 2:** Conocer al equipo de TripMate</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** acceda a la sección "Acerca de nosotros"</p><p>**Entonces** debería encontrar detalles sobre el equipo de TripMate</p>|EP06|
|US22|Sección “Convenios”|<p>**Como** visitante del landing page</p><p>**Quiero** poder visualizar los convenios que tiene TripMate</p><p>**Para** conocer las distintas empresas asociadas</p>|<p>**Escenario 1:** Ver los convenios de TripMate</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** navegue a la sección "Convenios"</p><p>**Entonces** debería visualizar los convenios que tiene TripMate con distintas empresas asociadas</p><p></p><p>**Escenario 2:** Conocer empresas asociadas</p><p></p><p>**Dado que** el usuario es un visitanta del landing page</p><p>**Cuando** navegue a la sección "Convenios"</p><p>**Entonces** debería encontrar información sobre las empresas asociadas con TripMate</p>|EP06|
|US23|Sección “Testimonios”|<p>**Como** visitante del landing page</p><p>**Quiero** poder ver testimonios y experiencias de otros usuarios</p><p>**Para** conocer la opinión del público sobre TripMate</p>|<p>**Escenario 1:** Ver testimonios de otros usuarios</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** acceda a la sección "Testimonios"</p><p>**Entonces** debería poder ver testimonios y experiencias de otros usuarios sobre TripMate</p><p></p><p>**Escenario 2:** Conocer la opinión del público</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** acceda a la sección "Testimonios"</p><p>**Entonces** debería poder formarse una opinión sobre TripMate a partir de los testimonios de otros usuarios</p>|EP06|
|US24|Acceder desde cualquier dispositivo a la landing page|<p>**Como** visitante del landing page</p><p>**Quiero** poder acceder al sitio web desde diferentes dispositivos</p><p>**Para** poder ingresar al sitio web desde cualquier dispositivo</p>|<p>**Escenario 1:** Accesibilidad desde diferentes dispositivos</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** acceda al sitio web desde un dispositivo diferente (móvil, tablet, PC)</p><p>**Entonces** debería poder visualizar la página correctamente en cualquier dispositivo</p><p></p><p>**Escenario 2:** Acceso fácil desde cualquier lugar</p><p></p><p>**Dado que** el usuario es un visitante del landing page</p><p>**Cuando** intente acceder al sitio web desde mi dispositivo habitual</p><p>**Entonces** debería poder ingresar a la página de TripMate desde cualquier lugar y dispositivo</p>|EP06|
|US25|Suscripción a membresía premium|<p>**Como** usuario</p><p>**Quiero** poder suscribirme a una membresía en la aplicación</p><p>**Para** poder adquirir beneficios adicionales</p>|<p>**Escenario 1:** Suscripción exitosa</p><p></p><p>**Dado** que el usuario está interesado en obtener beneficios adicionales en la aplicación</p><p>**Cuando** acceda a la sección de membresía premium</p><p>**Y** seleccione el plan premium</p><p>**Entonces** podrá completar el proceso de suscripción</p><p></p><p>**Escenario 2:** Error durante la suscripción</p><p></p><p>**Dado que** el usuario está interesado en obtener beneficios adicionales en la aplicación</p><p>**Cuando** intente suscribirse a la membresía premium</p><p>**Y** durante el proceso ingrese un método de pago incorrecto o haya un problema con el servicio de pago</p><p>**Entonces** recibirá un mensaje de error indicando la naturaleza del problema</p>|EP02|
|US26|Eliminar cuenta|<p>**Como** usuario</p><p>**Quiero** tener la opción de eliminar permanentemente mi cuenta y todos los datos asociados</p><p>**Para** borrar la información de mi cuenta de la aplicación</p><p></p>|<p>**Escenario 1:** Eliminar cuenta</p><p></p><p>**Dado que** el usuario ha decidido eliminar su cuenta de TripMate</p><p>**Cuando** acceda a la configuración de su cuenta y seleccione la opción para eliminarla</p><p>**Entonces** recibirá una confirmación </p><p>**Y**, después de confirmar, su cuenta y todos los datos asociados serán eliminados permanentemente</p><p></p><p>**Escenario 2:** Cancelar eliminación de cuenta</p><p></p><p>**Dado que** el usuario va a eliminar su cuenta</p><p>**Cuando** se muestre la confirmación de cancelar su cuenta</p><p>**Y** cancele la confirmación</p><p>**Entonces** la cuenta del usuario no se eliminará</p>|EP02|
|US27|Carrito de compras|<p>**Como** usuario</p><p>**Quiero** ver mi carrito de compras </p><p>**Para** para ver la lista y para confirmar sus actividades  </p><p></p>|<p>**Escenario 1:** Visualización del carrito de compras</p><p></p><p>**Dado que** el usuario desea ver su carrito de compras</p><p>**Cuando** acceda a la sección del carrito de compras en la aplicación</p><p>**Entonces** podrá visualizar una lista de los elementos que ha agregado al carrito</p><p>**Y**, se mostrará el total de la compra hasta el momento</p><p></p><p>**Escenario 2:** Reservar todo desde el carrito de compras</p><p></p><p>**Dado que** el usuario tiene lista en el carrito de compras y desea reservarlas todas de una vez.</p><p>**Cuando** el usuario acceda al carrito de compras y seleccione la opción "Reservar todo"</p><p>**Y** cancele la confirmación</p><p>**Entonces** todas las actividades que estaban en el carrito serán reservadas</p>|EP02|

**Technical User Stories**

|**Technical story ID**|**Título**|**Descripción**|
| :- | :- | :- |
|TS01|Get accommodations|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de los alojamientos mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Obtener alojamientos</p><p></p><p>**Dado que** el endpoint “/alojamientos está disponible</p><p>**Cuando** una get request es enviada</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se obtiene los datos de los alojamientos</p><p></p><p>**Escenario 2:**Alojamientos no disponibles</p><p></p><p>**Dado** que el endpoint “/alojamientos está disponible</p><p>**Cuando** una get request es enviada</p><p>**Y** no haya alojamientos disponibles</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No hay alojamientos disponibles”</p>|
|TS02|Get flights|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de los vuelos mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Obtener vuelos</p><p></p><p>**Dado que** el endpoint “/vuelos está disponible</p><p>**Cuando** una get request es enviada</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se obtiene los datos de los vuelos</p><p></p><p>**Escenario 2:**Vuelos no disponibles</p><p></p><p>**Dado** que el endpoint “/vuelos está disponible</p><p>**Cuando** una get request es enviada</p><p>**Y** no haya vuelos disponibles</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No hay vuelos disponibles”</p>|
|TS03|Get activities|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de las actividades mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Obtener actividades</p><p></p><p>**Dado que** el endpoint “/actividades está disponible</p><p>**Cuando** una get request es enviada</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se obtiene los datos de las actividades</p><p></p><p>**Escenario 2:**ACtividades no disponibles</p><p></p><p>**Dado** que el endpoint “/actividades está disponible</p><p>**Cuando** una get request es enviada</p><p>**Y** no haya actividades disponibles</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No hay actividades disponibles”</p>|
|TS04|Get restaurants|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de los restaurantes mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Obtener restaurantes</p><p></p><p>**Dado que** el endpoint “/restaurantes está disponible</p><p>**Cuando** una get request es enviada</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se obtiene los datos de los restaurantes</p><p></p><p>**Escenario 2:**Restaurantes no disponibles</p><p></p><p>**Dado** que el endpoint “/restaurantes está disponible</p><p>**Cuando** una get request es enviada</p><p>**Y** no haya restaurantes disponibles</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No hay restaurantes disponibles”</p>|
|TS05|Post Reservation|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar una nueva reserva asociada a un usuario mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p><p></p><p>**Escenario 1:** Añadir reserva nueva</p><p></p><p>**Dado que** el endpoint “/reservas” está disponible</p><p>**Cuando** una post request es enviada con los valores de la reserva</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se incluye una reserva con un nuevo id y sus valores registrados</p><p></p><p>**Escenario 2:** Añadir reserva ya existente</p><p></p><p>**Dado que** el endpoint “/reservas” está disponible</p><p>**Cuando** una post request es enviada con los datos de la reserva</p><p>**Y** una reserva ya esté registrada para ese servicio</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “Una reserva a este servicio ya existe”</p>|
|TS06|Get Reservation|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de las reservas por usuario mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Obtener reserva</p><p></p><p>**Dado que** el endpoint “/reservas” está disponible</p><p>**Cuando** una get request es enviada con el identificador de la reserva</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se obtiene los datos de la reserva</p><p></p><p>**Escenario 2:** Obtener reserva no disponible</p><p></p><p>**Dado** que el endpoint “/reservas” está disponible</p><p>**Cuando** una get request es enviada con el identificador de la reserva</p><p>**Y** el identificador no exista</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No existe una reserva con este identificador”</p>|
|TS07|Post Itinerary|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar un nuevo itinerario asociado a un usuario mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p><p></p><p>**Escenario 1:** Añadir itinerario nuevo</p><p></p><p>**Dado que** el endpoint “/itinerarios” está disponible</p><p>**Cuando** una post request es enviada con los valores del itinerario</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se incluye un itinerario con un nuevo id y sus valores registrados</p><p></p><p>**Escenario 2:** Añadir itinerario ya existente</p><p></p><p>**Dado que** el endpoint “/itinerarios” está disponible</p><p>**Cuando** una post request es enviada con los datos del itinerario</p><p>**Y** un itinerario con ese nombre ya esté registrado</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “Un itinerario con estos datos ya existe”</p>|
|TS08|Get Itinerary|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información sobre itinerarios de viaje por usuario **mediante una API**</p><p>**Para** mostrarla en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Obtener itinerario</p><p></p><p>**Dado que** el endpoint “/itinerarios” está disponible</p><p>**Cuando** una get request es enviada con el identificador del itinerario</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se obtiene los datos del itinerario</p><p></p><p>**Escenario 2:** Obtener itinerario no disponible</p><p></p><p>**Dado** que el endpoint “/itinerarios” está disponible</p><p>**Cuando** una get request es enviada con el identificador del itinerario</p><p>**Y** el identificador no exista</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No existe un itinerario con este identificador”</p>|
|TS09|Identity and Access Management (IAM)|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información de perfil de usuario **mediante una API**</p><p>**Para** mostrarla en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Obtener información de perfil de usuario</p><p></p><p>**Dado que** el endpoint “/users/{id}” está disponible</p><p>**Cuando** una get request es enviada con el identificador del usuario y un token de autenticación válido</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se obtiene los datos del perfil del usuario</p><p></p><p>**Escenario 2:** Usuario no encontrado</p><p></p><p>**Dado** que el endpoint “/users/{id}” está disponible</p><p>**Cuando** una get request es enviada con el identificador del usuario y un token de autenticación válido</p><p>**Y** el identificador del usuario no existe</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “Usuario no encontrado”</p>|
|TS10|Delete accommodations|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de los alojamientos mediante una API</p><p>**Para** que no se muestre en la aplicación </p><p></p><p>**Escenario 1:** Borrar alojamientos</p><p></p><p>**Dado que** el endpoint “/alojamientos/{id} está disponible</p><p>**Cuando** una delete request es enviada</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se borra los datos del alojamiento</p><p></p><p>**Escenario 2:** Alojamiento no disponibles</p><p></p><p>**Dado** que el endpoint “/alojamientos/{id} está disponible</p><p>**Cuando** una delete request es enviada</p><p>**Y** no exista el alojamiento</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No hay alojamientos con esa id”</p>|
|TS11|Delete flights|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de los vuelos mediante una API</p><p>**Para** que no se muestre en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Borrar vuelos</p><p></p><p>**Dado que** el endpoint “/vuelos/{id} está disponible</p><p>**Cuando** una delete request es enviada</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se borra los datos del vuelo</p><p></p><p>**Escenario 2:** Vuelo no disponible</p><p></p><p>**Dado** que el endpoint “/vuelos/{id} está disponible</p><p>**Cuando** una delete request es enviada</p><p>**Y** no xista el vuelo</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No hay vuelos con esa id”</p>|
|TS12|Delete activities|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de las actividades mediante una API</p><p>**Para** que no se muestre en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Borrar actividad</p><p></p><p>**Dado que** el endpoint “/actividades/{id} está disponible</p><p>**Cuando** una delete request es enviada</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** borra los datos de la actividad</p><p></p><p>**Escenario 2:** Actividades no disponibles</p><p></p><p>**Dado** que el endpoint “/actividades/{id} está disponible</p><p>**Cuando** una delete request es enviada</p><p>**Y** no exista actividad</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No hay actividades con esa id”</p>|
|TS13|Delete restaurants|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de los restaurantes mediante una API</p><p>**Para** que no se muestre en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Borrar restaurantes</p><p></p><p>**Dado que** el endpoint “/restaurantes/{id} está disponible</p><p>**Cuando** una delete request es enviada</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se borra los datos del restaurante</p><p></p><p>**Escenario 2:** Restaurantes no disponibles</p><p></p><p>**Dado** que el endpoint “/restaurantes/{id} está disponible</p><p>**Cuando** una delete request es enviada</p><p>**Y** no exista el restaurant</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No hay restaurantes con esa id”</p>|
|TS14|Put accommodations|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** modificar la información de los alojamientos mediante una API</p><p>**Para** que se muestre actualizada en la aplicación </p><p></p><p>**Escenario 1:** Modificar alojamientos</p><p></p><p>**Dado que** el endpoint “/alojamientos/{id} está disponible</p><p>**Cuando** una put request es enviada</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se modifica los datos del alojamiento</p><p></p><p>**Escenario 2:** Alojamiento no disponibles</p><p></p><p>**Dado** que el endpoint “/alojamientos/{id} está disponible</p><p>**Cuando** una put request es enviada</p><p>**Y** no exista el alojamiento</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No hay alojamientos con esa id”</p>|
|TS15|Put flights|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** modificar la información de los vuelos mediante una API</p><p>**Para** que se muestre actualizada en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Modificar vuelos</p><p></p><p>**Dado que** el endpoint “/vuelos/{id} está disponible</p><p>**Cuando** una put request es enviada</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se modifica los datos del vuelo</p><p></p><p>**Escenario 2:**Vuelo no disponible</p><p></p><p>**Dado** que el endpoint “/vuelos/{id} está disponible</p><p>**Cuando** una put request es enviada</p><p>**Y** no exista el vuelo</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No hay vuelos con esa id”</p>|
|TS16|Put activities|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de las actividades mediante una API</p><p>**Para** que no se muestre en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Modificar actividad</p><p></p><p>**Dado que** el endpoint “/actividades/{id} está disponible</p><p>**Cuando** una put request es enviada</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** modifica los datos de la actividad</p><p></p><p>**Escenario 2:**Actividades no disponibles</p><p></p><p>**Dado** que el endpoint “/actividades/{id} está disponible</p><p>**Cuando** una put request es enviada</p><p>**Y** no exista actividad</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No hay actividades con esa id”</p>|
|TS17|Put restaurants|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** modificar la información de los restaurantes mediante una API</p><p>**Para** que se muestre actualizada en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Modificar restaurantes</p><p></p><p>**Dado que** el endpoint “/restaurantes/{id} está disponible</p><p>**Cuando** una put request es enviada</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se modifica los datos del restaurante</p><p></p><p>**Escenario 2:**Restaurantes no disponibles</p><p></p><p>**Dado** que el endpoint “/restaurantes/{id} está disponible</p><p>**Cuando** una put request es enviada</p><p>**Y** no exista el restaurant</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “No hay restaurantes con esa id”</p>|
...
| :- | :- | :- | :- | :- |
|1|US05|Búsqueda por filtros|<p>**Como** usuario</p><p>**Quiero** buscar vuelos, alojamientos, restaurantes y actividades utilizando filtros</p><p>**Para** explorar opciones según mis intereses y preferencias</p>|<p></p><p>5</p>|
|2|US06|Ver alojamientos|<p>**Como** usuario</p><p>**Quiero** ver todos los alojamientos disponibles en la aplicación</p><p>**Para** poder planificar mi viaje y mi itinerario</p>|<p></p><p>8</p>|
|3|US07|Ver vuelos|<p>**Como** usuario</p><p>**Quiero** ver todos vuelos disponibles en la aplicación</p><p>**Para** poder planificar mi viaje y mi itinerario</p>|<p></p><p>8</p>|
|4|US08|Ver actividades|<p>**Como** usuario</p><p>**Quiero** ver todas las actividades disponibles en la aplicación</p><p>**Para** poder planificar mi viaje y mi itinerario</p>|<p></p><p>8</p>|
|5|US09|Ver restaurantes|<p>**Como** usuario</p><p>**Quiero** ver todos los restaurantes disponibles en la aplicación</p><p>**Para** poder planificar mi viaje y mi itinerario</p>|<p></p><p>8</p>|
|6|US10|Reservar alojamiento|<p>**Como** usuario </p><p>**Quiero** poder reservar alojamiento en la aplicación</p><p>**Para** asegurar mi hospedaje durante el viaje</p>|<p></p><p>8</p>|
|7|US11|Reservar vuelos|<p>**Como** usuario </p><p>**Quiero** poder reservar vuelos en la aplicación</p><p>**Para** poder planificar mi viaje de manera eficiente</p>|<p></p><p>8</p>|
|8|US12|Reservar actividades|<p>**Como** usuario </p><p>**Quiero** poder reservar actividades en la aplicación</p><p>**Para** poder planificar mi viaje de manera eficiente</p>|<p></p><p>8</p>|
|9|US13|Reservar restaurantes|<p>**Como** usuario </p><p>**Quiero** poder reservar restaurantes en la aplicación</p><p>**Para** poder planificar mi viaje de manera eficiente</p>|<p></p><p>8</p>|
|10|US14|Planificar itinerario|<p>**Como** usuario</p><p>**Quiero** poder planificar mi itinerario en la aplicación</p><p>**Para** organizar mis actividades durante el viaje</p>|<p></p><p>8</p>|
|11|US16|Aplicación de códigos promocionales|<p>**Como** usuario</p><p>**Quiero** tener la opción de ingresar códigos promocionales durante el proceso de pago</p><p>**Para** obtener descuentos adicionales en los servicios ofrecidos</p><p></p>|<p></p><p>3</p>|
|12|US15|Realizar pago|<p>**Como** usuario</p><p>**Quiero** poder realizar los pagos dentro de la aplicación</p><p>**Para** poder terminar de planificar el viaje</p>|<p></p><p>3</p>|
|13|US25|Suscripción a membresía premium|<p>**Como** usuario</p><p>**Quiero** poder suscribirme a una membresía en la aplicación</p><p>**Para** poder adquirir beneficios adicionales</p>|<p></p><p>3</p>|
|14|US19|Visualizar una landing page atractiva|<p>**Como** visitante del landing page</p><p>**Quiero** visualizar una landing page clara y atractiva</p><p>**Para** entender el propósito de la aplicación</p>|<p></p><p>3</p>|
|15|US20|Visualizar features de la aplicación|<p>**Como** visitante del landing page</p><p>**Quiero** visualizar todos las funcionalidades y servicios que brinda TripMate</p><p>**Para** entender el uso de la aplicación</p>|<p></p><p>3</p>|
|16|US21|Sección “Acerca de nosotros”|<p>**Como** visitante del landing page</p><p>**Quiero** visualizar una sección que me informe sobre el startup</p><p>**Para** conocer al equipo de TripMate y su propósito</p>|<p></p><p>3</p>|
|17|US22|Sección “Convenios”|<p>**Como** visitante del landing page</p><p>**Quiero** visualizar los convenios que tiene TripMate</p><p>**Para** conocer las distintas empresas asociadas</p>|<p></p><p>3</p>|
|18|US23|Sección “Testimonios”|<p>**Como** visitante del landing page</p><p>**Quiero** poder ver testimonios y experiencias de otros usuarios</p><p>**Para** conocer la opinión del público sobre TripMate</p>|<p></p><p>3</p>|
|19|US24|Acceder desde cualquier dispositivo a la landing page|<p>**Como** visitante del landing page</p><p>**Quiero** que sea accesible desde diferentes dispositivos </p><p>**Para** poder ingresar al sitio web desde cualquier dispositivo</p>|<p></p><p>3</p>|
|20|US18|Dar feedback|<p>**Como** usuario</p><p>**Quiero** poder proporcionar feedback sobre la aplicación</p><p>**Para** compartir sugerencias o comentarios que ayuden a mejorar la experiencia del usuario</p>|<p></p><p>2</p>|
|21|US17|Contactar al soporte|<p>**Como** usuario</p><p>**Quiero** poder contactar al equipo de soporte de la aplicación</p><p>**Para** obtener ayuda con problemas técnicos</p>|<p></p><p>2</p>|
|22|US01|Registro de usuario|<p>**Como** usuario nuevo</p><p>**Quiero** poder registrarme en TripMate** </p><p>**Para** poder acceder a todas las funcionalidades de la aplicación</p>|<p></p><p>1</p>|
|23|US02|Inicio de sesión|<p>**Como** usuario registrado</p><p>**Quiero** poder iniciar sesión en la aplicación</p><p>**Para** acceder a mi cuenta</p>|<p></p><p>1</p>|
|24|US03|Recuperación de contraseña|<p>**Como** usuario registrado</p><p>**Quiero** tener la opción de recuperación de contraseña</p><p>**Para** poder acceder a mi cuenta sin problemas</p>|<p></p><p>1</p>|
|25|US04|Cambiar dirección de correo electrónico|<p>**Como** usuario</p><p>**Quiero** poder cambiar la dirección de correo electrónico asociada a mi cuenta</p><p>**Para** mantener mi información de contacto actualizada</p>|<p></p><p>1</p>|
|26|US26|Eliminar cuenta|<p>**Como** usuario</p><p>**Quiero** tener la opción de eliminar permanentemente mi cuenta y todos los datos asociados</p><p>**Para** borrar la información de mi cuenta de la aplicación</p><p></p>|<p></p><p>1</p>|
|27|TS01|Get accommodations|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de los alojamientos mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>8</p>|
|28|TS02|Get flights|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de los vuelos mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>8</p>|
|29|TS03|Get restaurants|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de los restaurantes mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>8</p>|
|30|TS04|Get activities|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de las actividades mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>8</p>|
|31|TS05|Post Reservation|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar una nueva reserva asociada a un usuario mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p>|<p></p><p>5</p>|
|32|TS06|Get Reservation|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de las reservas por usuario mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>3</p>|
|33|TS07|Post Itinerary|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar un nuevo itinerario asociado a un usuario mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p>|<p></p><p>5</p>|
|34|TS08|Get Itinerary|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información sobre itinerarios de viaje por usuario **mediante una API**</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>3</p>|
|35|TS09|Identity and Access Management (IAM)|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información de perfil de usuario **mediante una API**</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>4</p>|
|36|TS10|Delete accommodations|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de los alojamientos mediante una API</p><p>**Para** que no se muestre en la aplicación </p>|<p></p><p>4</p>|
|37|TS11|Delete flights|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de los vuelos mediante una API</p><p>**Para** que no se muestre en la aplicación cuando se solicite</p>|<p></p><p>4</p>|
|38|TS12|Delete activities|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de las actividades mediante una API</p><p>**Para** que no se muestre en la aplicación cuando se solicite</p>|<p></p><p>4</p>|
|39|TS13|Delete restaurants|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de los restaurantes mediante una API</p><p>**Para** que no se muestre en la aplicación cuando se solicite</p>|<p></p><p>4</p>|
|40|TS14|Put accommodations|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** modificar la información de los alojamientos mediante una API</p><p>**Para** que se muestre actualizada en la aplicación </p>|<p></p><p>4</p>|
|41|TS15|Put flights|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** modificar la información de los vuelos mediante una API</p><p>**Para** que se muestre actualizada en la aplicación cuando se solicite</p>|<p></p><p>4</p>|
|42|TS16|Put activities|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de las actividades mediante una API</p><p>**Para** que no se muestre en la aplicación cuando se solicite</p>|<p></p><p>4</p>|
|43|TS17|Put restaurants|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** modificar la información de los restaurantes mediante una API</p><p>**Para** que se muestre actualizada en la aplicación cuando se solicite</p>|<p></p><p>4</p>|
...
| **Sum of Story Points** | 12 |
  ...
  - 5.2.1.2. Sprint Backlog 1
    ...
    |US21|Sección “Acerca de nosotros”|W-02|Sección “Acerca de Nosotros**”**|<p>**Como** visitante del landing page</p><p>**Quiero** visualizar una sección que me informe sobre el startup</p><p>**Para** conocer al equipo de TripMate y su propósito</p>|2 hours|**Leonel Alfaro**|Done|
    |US22|Sección “Convenios”|W-03|Sección “Convenios”|<p>**Como** visitante del landing page</p><p>**Quiero** visualizar los convenios que tiene TripMate</p><p>**Para** conocer las distintas empresas asociadas</p>|2 hours|**Jeremy Quispe**|Done|
    |US23|Sección “Testimonios”|W-04|Sección “Testimonios”|<p>**Como** visitante del landing page</p><p>**Quiero** poder ver testimonios y experiencias de otros usuarios</p><p>**Para** conocer la opinión del público sobre TripMate</p>|2 hours|**Paolo Martinez**|Done|
...
| **Sum of Story Points** | 45 |
  ...
  - 5.2.2.2. Sprint Backlog 2
    ...
    |User Story|Work-Item / Task|||||||
    |Id|Title|Id|Title|Description|Estimation (hours)|Assigned To|Status (To-do / In-Process / To-Review / Done)|
    |US01|Registro de usuario|W-01|Seccion Register|<p>**Como** usuario nuevo</p><p>**Quiero** poder registrarme en TripMate</p><p>**Para** poder acceder a todas las funcionalidades de la aplicación</p>|3 hours|**Bárbara Espinoza**|Done|
    |US02|Inicio de sesión|W-02|Sección Sign In|<p>**Como** usuario registrado</p><p>**Quiero** poder iniciar sesión en la aplicación</p><p>**Para** acceder a mi cuenta</p>|3 hours|**Bárbara Espinoza**|Done|
    |US03|Recuperación de contraseña|W-03|Opción Recuperar Contraseña|<p>**Como** usuario registrado</p><p>**Quiero** tener la opción de recuperación de contraseña</p><p>**Para** poder acceder a mi cuenta sin problemas</p>|2 hours|**Paolo Martinez**|Done|
    |US04|Cambiar dirección de correo electrónico|W-04|Opción Cambiar Correo|<p>**Como** usuario</p><p>**Quiero** poder cambiar la dirección de correo electrónico asociada a mi cuenta</p><p>**Para** mantener mi información de contacto actualizada</p>|2 hours|**Paolo Martinez**|Done|
    |US05|Búsqueda por filtros|W-05|Aplicación de filtros en cada sección|<p>**Como** usuario</p><p>**Quiero** buscar vuelos, alojamientos, restaurantes y actividades utilizando filtros</p><p>**Para** explorar opciones según mis intereses y preferencias</p>|4 hours|**Leonel Alfaro**|Done|
    ...
    |US10|Reservar alojamiento|W-11|Reserva de alojamientos|<p>**Como** usuario</p><p>**Quiero** poder reservar alojamiento en la aplicación</p><p>**Para** asegurar mi hospedaje durante el viaje</p>|2 hours|**Adrian Palma**|Done|
    |US11|Reservar vuelos|W-12|Reserva de alojamientos|<p>**Como** usuario</p><p>**Quiero** poder reservar vuelos en la aplicación</p><p>**Para** poder planificar mi viaje de manera eficiente</p>|2 hours|**Jeremy Quispe**|Done|
    |US12|Reservar actividades|W-13|Reserva de alojamientos|<p>**Como** usuario</p><p>**Quiero** poder reservar actividades en la aplicación</p><p>**Para** poder planificar mi viaje de manera eficiente</p>|2 hours|**Bárbara Espinoza**|Done|
    |US13|Reservar restaurantes|W-14|Reserva de alojamientos|<p>**Como** usuario</p><p>**Quiero** poder reservar restaurantes en la aplicación</p><p>**Para** poder planificar mi viaje de manera eficiente</p>|2 hours|**Paolo Martinez**|Done|
    |US14|Planificar itinerario|W-15|Planificación de itinerario|<p>**Como** usuario</p><p>**Quiero** poder planificar mi itinerario en la aplicación</p><p>**Para** organizar mis actividades durante el viaje</p>|1 hours|**Leonel Alfaro**|Done|
    ...
    |US16|Aplicación de códigos promocionales|W-17|Ingreso de códigos promocionales|<p>**Como** usuario</p><p>**Quiero** tener la opción de ingresar códigos promocionales durante el proceso de pago</p><p>**Para** obtener descuentos adicionales en los servicios ofrecidos</p>|1 hours|**Jeremy Quispe**|Done|
    |US17|Contactar al soporte|W-18|Contacto con soporte|<p>**Como** usuario</p><p>**Quiero** poder contactar al equipo de soporte de la aplicación</p><p>**Para** obtener ayuda con problemas técnicos</p>|1 hours|**Bárbara Espinoza**|Done|
...
| **Prepared By** | Adrián Enrique Jesús Palma Obispo  |
| Attendees | - Adrián Enrique Jesús Palma Obispo (u202210066)<br>- Paolo Del Carmen Martinez Villanueva (u202010039)<br>- Bárbara Antonella Espinoza Delgado (u201911727)<br>- Jeremy Joel Quispe Andia (u202216279)<br>- Leonel Alfaro Cumba (u20201a930) |
| **Sprint 3 Review Summary** | En el sprint anterior, logramos completar las user stories. |
...
|User Story|Work-Item / Task|||||||
|Id|Title|Id|Title|Description|Estimation (hours)|Assigned To|Status (To-do / In-Process / To-Review / Done)|
|TS01|Get Accommodations|W-01|Implementación de Obtención de Alojamientos|<p>**Como** usuario de TripMate</p><p>**Quiero** obtener información sobre los alojamientos disponibles</p><p>**Para** poder planificar y reservar mi hospedaje para mis viajes</p>|2 hours|**Paolo Martinez**|To-do|
|TS02|Get Flights|W-02|Implementación de Obtención de Vuelos|<p>**Como** usuario de TripMate</p><p>**Quiero** obtener información sobre los vuelos disponibles</p><p>**Para** poder planificar y reservar mis viajes de manera eficiente</p>|2 hours|**Adrián Palma**|To-do|
|TS03|Get Restaurants|W-03|Implementación de Obtención de Restaurantes|<p>**Como** usuario de TripMate</p><p>**Quiero** obtener información sobre los restaurantes disponibles</p><p>**Para** poder planificar y reservar mis comidas durante mis viajes</p>|2 hours|**Paolo Martinez**|To-do|
|TS05|Post Reservation|W-04|Implementación de Registro de Reserva|<p>**Como** usuario de TripMate</p><p>**Quiero** poder realizar una reserva en la aplicación</p><p>**Para** asegurar mi lugar en alojamientos, vuelos, actividades o restaurantes durante mis viajes</p>|4 hours|**Jeremy Quispe**|To-do|
|TS06|Get Reservation|W-05|Implementación de Obtención de Reserva|<p>**Como** usuario de TripMate</p><p>**Quiero** obtener información sobre mis reservas realizadas</p><p>**Para** poder revisar y gestionar mis reservas de viaje de manera fácil</p>|2 hours|**Leonel Alfaro**|To-do|
|TS07|Post Itinerary|W-06|Implementación de Registro de Itinerario|<p>**Como** usuario de TripMate</p><p>**Quiero** poder crear un itinerario para mi viaje</p><p>**Para** organizar y planificar mis actividades durante mi viaje</p>|4 hours|**Jeremy Quispe**|To-do|
|TS08|Get Itinerary|W-07|Implementación de Obtención de Itinerario|<p>**Como** usuario de TripMate</p><p>**Quiero** obtener información sobre mi itinerario de viaje</p><p>**Para** poder visualizar y seguir mi planificación de actividades durante mi viaje</p>|2 hours|**Adrián Palma**|To-do|
...
| Entrevistado N°5: Juan José Navarro Chacón |<img src="https://github.com/TripTeamOrganization/Reports/assets/98995070/57bc0924-48de-4a2d-bfa0-cdf7af1883b8" alt="Andrés Valle" style="width: 300px;">|
|--------------------------------|------------------------------------------------------------|
...
|User Story|Work-Item / Task|||||||
|Id|Title|Id|Title|Description|Estimation (hours)|Assigned To|Status (To-do / In-Process / To-Review / Done)|
|TS04|Get Activities|W-01|Implementación de Obtención de Actividades|<p>**Como** usuario de TripMate</p><p>**Quiero** obtener información sobre las actividades disponibles</p><p>**Para** poder planificar y reservar actividades durante mis viajes</p>|2 hours|**Bárbara Espinoza**|To-do|
|TS09|Identity and Access Management (IAM)|W-02|Adición del IAM al proyecto|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información de perfil de usuario **mediante una API**</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|2 hours|**Adrián Palma**|To-do|  
|TS10|Delete accommodations|W-02|Implementación de Eliminación de Acommodations|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de los alojamientos mediante una API</p><p>**Para** que no se muestre en la aplicación cuando se solicite</p>|3 hours|**Jeremy Quispe**|To-do| 
|TS11|Delete flights|W-03|Implementación de Eliminación de Vuelos|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de los vuelos mediante una API</p><p>**Para** que no se muestre en la aplicación cuando se solicite</p>|3 hours|**Jeremy Quispe**|To-do| 
|TS12|Delete activities|W-04|Implementación de Eliminación de Actividades|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de las actividades mediante una API</p><p>**Para** que no se muestre en la aplicación cuando se solicite</p>|3 hours|**Paolo Martinez**|To-do| 
|TS13|Delete restaurants|W-05|Implementación de Eliminación de Restaurantes|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de los restaurantes mediante una API</p><p>**Para** que no se muestre en la aplicación cuando se solicite</p>|3 hours|**Paolo Martinez**|To-do| 
|TS14|Put accommodations|W-06|Implementación de Modificación de Acommodations|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** modificar la información de los alojamientos mediante una API</p><p>**Para** que se muestre actualizada en la aplicación </p>|2 hours|**Jeremy Quispe**|To-do| 
|TS15|Put flights|W-07|Implementación de Modificación de Vuelos|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** modificar la información de los vuelos mediante una API</p><p>**Para** que se muestre actualizada en la aplicación cuando se solicite</p>|2 hours|**Jeremy Quispe**|To-do| 
|TS16|Put activities|W-08|Implementación de Modificación de Actividades|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** borrar la información de las actividades mediante una API</p><p>**Para** que no se muestre en la aplicación cuando se solicite</p>|2 hours|**Paolo Martinez**|To-do| 
|TS17|Put restaurants|W-09|Implementación de Modificación de Restaurantes|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** modificar la información de los restaurantes mediante una API</p><p>**Para** que se muestre actualizada en la aplicación cuando se solicite</p>|2 hours|**Paolo Martinez**|To-do| 

![imagen](https://github.com/TripTeamOrganization/Reports/assets/98995070/9b38fefe-a5ef-4a43-a66b-1a41858ca9bd)  
...
En el sprint 2, se han implementado importantes características para mejorar la experiencia del usuario, incluyendo el registro de usuario, inicio de sesión y cambio de dirección de correo electrónico. Además, se ha trabajado en la funcionalidad de búsqueda para vuelos, alojamientos, restaurantes y actividades, así como la posibilidad de ver y reservar cada uno de estos servicios. También se ha incluido la opción de planificar itinerarios, realizar pagos y aplicar códigos promocionales para obtener descuentos adicionales.
