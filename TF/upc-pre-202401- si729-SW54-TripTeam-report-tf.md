...
|TS11|Identity and Access Management (IAM)|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información de perfil de usuario **mediante una API**</p><p>**Para** mostrarla en la aplicación cuando se solicite</p><p></p><p>**Escenario 1:** Obtener información de perfil de usuario</p><p></p><p>**Dado que** el endpoint “{id}/user” está disponible</p><p>**Cuando** una get request es enviada con el identificador del usuario y un token de autenticación válido</p><p>**Entonces** una respuesta es recibida con status 201</p><p>**Y** se obtiene los datos del perfil del usuario</p><p></p><p>**Escenario 2:** Usuario no encontrado</p><p></p><p>**Dado** que el endpoint “{id}/user” está disponible</p><p>**Cuando** una get request es enviada con el identificador del usuario y un token de autenticación válido</p><p>**Y** el identificador del usuario no existe</p><p>**Entonces** una respuesta es recibida con status 400</p><p>**Y** se mostrará un mensaje que dice “Usuario no encontrado”</p>|
