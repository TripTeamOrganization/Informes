...
|27|TS01|Post User|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar a un nuevo usuario mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p>|<p></p><p>3</p>|
...
|29|TS03|Get accommodations|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de los alojamientos mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>8</p>|
|30|TS04|Get flights|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de los vuelos mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>8</p>|
|31|TS05|Get restaurants|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de los restaurantes mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>8</p>|
|32|TS06|Get activities|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de las actividades mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>8</p>|
|33|TS07|Post Reservation|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar una nueva reserva asociada a un usuario mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p>|<p></p><p>5</p>|
|34|TS08|Get Reservation|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información de las reservas por usuario mediante una API</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>3</p>|
|35|TS09|Post Itinerary|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** registrar un nuevo itinerario asociado a un usuario mediante una API</p><p>**Para** que esté disponible para crear funcionalidades en mi aplicación</p>|<p></p><p>5</p>|
|36|TS10|Get Itinerary|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener la información sobre itinerarios de viaje por usuario **mediante una API**</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>3</p>|
|37|TS11|Identity and Access Management (IAM)|<p>**Como** desarrollador que trabaja en la aplicación de TripMate</p><p>**Quiero** obtener información de perfil de usuario **mediante una API**</p><p>**Para** mostrarla en la aplicación cuando se solicite</p>|<p></p><p>4</p>|
...
|TS03|Get Accommodations|W-03|Implementación de Obtención de Alojamientos|<p>**Como** usuario de TripMate</p><p>**Quiero** obtener información sobre los alojamientos disponibles</p><p>**Para** poder planificar y reservar mi hospedaje para mis viajes</p>|2 hours|**Paolo Martinez**|To-do|
|TS04|Get Flights|W-04|Implementación de Obtención de Vuelos|<p>**Como** usuario de TripMate</p><p>**Quiero** obtener información sobre los vuelos disponibles</p><p>**Para** poder planificar y reservar mis viajes de manera eficiente</p>|2 hours|**Adrián Palma**|To-do|
